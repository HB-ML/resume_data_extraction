...
def extract_hobbies(text):
    ...
    record1 = 'hobbies'
    if record1:
        text1 = re.findall(record1, test_str, flags=re.IGNORECASE)
        if text1:
            text1 = "".join(text1)
            sub1 = "".join(test_str.split(text1)[1])
            sub2 = "".join(sub1.split(".", 1)[0])
            if sub2:
                return sub2

    record2 = 'hobby'
    if record2:
        text1 = re.findall(record2, test_str, flags=re.IGNORECASE)
        if text1:
            text1 = "".join(text1)
            sub1 = "".join(test_str.split(text1)[1])
            sub2 = "".join(sub1.split(".", 1)[0])
    ...
    record3 = 'interests'
    if record3:
        text1 = re.findall(record3, test_str, flags=re.IGNORECASE)
        if text1:
            text1 = "".join(text1)
            sub1 = "".join(test_str.split(text1)[1])
            sub2 = "".join(sub1.split(".", 1)[0])
    ...
    record4 = 'interest'
    if record4:
        text1 = re.findall(record4, test_str, flags=re.IGNORECASE)
        if text1:
            text1 = "".join(text1)
            sub1 = "".join(test_str.split(text1)[1])
            sub2 = "".join(sub1.split(".", 1)[0])
